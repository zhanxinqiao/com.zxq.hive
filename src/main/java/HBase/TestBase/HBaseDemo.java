...
public class HBaseDemo {
  ...
  //
    ...
    /*
     * 假设与10个用户，每个用户一年产生10000个记录
     * */
    @Test
    public void insertManeyData() throws ParseException, IOException {
    ...
    private String getDate(String s) {
        return s + String.format("%02d%02d%02d%02d%02d", random.nextInt(12) + 1,
    random.nextInt(31), random.nextInt(24), random.nextInt(60), random.nextInt(60));
    }
    ...
    * */
    @Test
    public void scanByCondition() throws ParseException, IOException {
        Scan scan = new Scan();
        String startRow="15887087405_"+(Long.MAX_VALUE-sdf.parse("20190331000000").getTime());
        String stopRow="15887087405_"+(Long.MAX_VALUE-sdf.parse("20190301000000").getTime());
        ...
        for (Result result : scanner) {
            ...
            System.out.println("---"+Bytes.toString(CellUtil.cloneValue(result.getColumnLatestCell(Bytes.toBytes("cf"),Bytes.toBytes("date")))));
    ...
    public void getType() throws IOException {
        ...
        //创建过滤器
        SingleColumnValueExcludeFilter filter1=new
                SingleColumnValueExcludeFilter(Bytes.toBytes("cf"),Bytes.toBytes("type"), CompareOperator.EQUAL,Bytes.toBytes("1"));
        filters.addFilter(filter1);
        //前缀过滤器
        PrefixFilter filter2 = new PrefixFilter(Bytes.toBytes("15887087405"));
